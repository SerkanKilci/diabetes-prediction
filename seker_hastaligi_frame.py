...
# -*- coding: utf-8 -*-
"""
Created on Wed May 11 18:00:31 2022
...
#verimizi yüklüyoruz
data = pd.read_csv("diabetes.csv")#path diabetes csv
data.head()
print(data)

#şeker hastası ve sağlıklı insanları pandas kütüphanesi yardımıyla ayırıyoruz
seker_hastalari = data[data.Outcome==1]
saglikli_insanlar= data[data.Outcome==0]


#şimdilik sadece glikoza bakarak bir örnek çizim 
...
#outcome sütununu çıkarıp sadece bağımsız değişkenleri bırakıyoruz
...
ws = Tk()
ws.title("Şeker Hastalığı Tahmini")
ws.geometry('600x400')
ws['bg'] = '#ffbf00'
